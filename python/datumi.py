...
def stevilo_dni(mesec, leto):
    if mesec in [1,3,5,7,8,10,12]:
        return 31
    elif je_prestopno(leto) and mesec == 2:
        return 29
    elif mesec == 2:
        return 28
    else:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5Mjd9:1j4479:TncITMQf5WXCCUQKyiON-84GY2Q'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5Mjh9:1j4479:9FpEiRxCapTG4bpTYNrnr3iKtp8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5Mjl9:1j4479:_neJU_1GMVhaoVy_vOS-IjyW3CA'
        try:
