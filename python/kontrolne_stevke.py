...
def dodaj_kontrolno_stevko(sklic)
    ...
    n05 = (sklic // 10000) % 10
    n06 = (sklic // 100000) % 10
    n07 = (sklic // 1000000) % 10
    n08 = (sklic // 10000000) % 10
    n09 = (sklic // 100000000) % 10
    n10 = (sklic // 1000000000) % 10
    n11 = (sklic // 10000000000) % 10
    n12 = (sklic // 100000000000) % 10
    vsota = n01 * 2 + n02 * 3 + n03 * 4 + n04 * 5 + n05 * 6 + n06 * 7 + n07 * 8 + n08 * 9 + n09 * 10 + n10 * 11 + n11 * 12 + n12 * 13 
    stevka = 11 - ( vsota % 11)

    if stevka<10:
        return sklic * 10 + stevka
    else : 
        return sklic * 10
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5MjR9:1j43Yn:eDTfyVQPm6GwBf1J4OrtCFSiZZM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5MjV9:1j43Yn:X0WqK5lfkSFYvuRaMkAtN-33BI0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5MjZ9:1j43Yn:cD4FFQLm69NAnasfFUBgfW3QDXQ'
        try:
