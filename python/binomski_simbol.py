...
def binomski_rekurzija(n, k):
    if n==k or k==0:
        ...
        return binomski_fakulteta(n-1, k) + binomski_fakulteta(n-1, k-1)
# =====================================================================@000952=
# 3. podnaloga
...
def binomski_ucinkovit(n, k):
    if k==0:
        ...
        return (n - k + 1) / k * binomski_fakulteta(n, k-1)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5NTB9:1j6buO:utweErPNUktD7_AOYKx-xbQQ0Pk'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5NTF9:1j6buO:VV5EJldj9D6ChvhX7Y3xN36en4I'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5NTJ9:1j6buO:cmLuQHWolkC9VtikDkDPEMA6UTg'
        try:
