...
def najmanjse_stevilo_z_vsoto_stevk(n):
    if n == 0:
        return 0
    elif vsota_stevk(n)<10:
        return vsota_stevk(n)
    else: 
        return n % 9 + 10 * najmanjse_stevilo_z_vsoto_stevk(n)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5NTZ9:1j6aT2:gmVx4XzDwUnATlUWZm8KOO5WgCM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5NTd9:1j6aT2:UF7eRbBZ5sesj_g0C10sEfs1b4A'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5NTh9:1j6aT2:PlCzba2HxgDEdC6RAC6becQGjls'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU1LCJwYXJ0Ijo5NTl9:1j6aT2:oFWKMnlEzgPD8Djcd4ns8nm_j4E'
        try:
            for i in range(1, 100):
