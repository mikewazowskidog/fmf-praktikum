...
urnikov, predstavljena je tudi metoda merjenja kakovosti izdelanega urnika. Med postopki za izdelavo urnikov najdemo požrešno metodo in optimizacijske metode. 
\end{abstract}
...
\[
   \text{velikostTabele}=\text{številoUrNaDan} \cdot \text{številoDelovnihUri}   
\]
